...
public class KafkaListenerConfig {
    ...
    @Bean
    public ConsumerFactory<String, TraceableMessage<CancelReservationRequest>> consumerFactory() throws Exception {
    	
    	JacksonAvroDeserializer<TraceableMessage<CancelReservationRequest>> jad = new JacksonAvroDeserializer<>();
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, TraceableMessage<CancelReservationRequest>> kafkaListenerContainerFactory() throws Exception {
    
        ConcurrentKafkaListenerContainerFactory<String, TraceableMessage<CancelReservationRequest>> factory = new ConcurrentKafkaListenerContainerFactory<>();
